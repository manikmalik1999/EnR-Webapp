  ...
  return (
    <Card>
      ...
      <GridContainer justify="center" alignItems="center" style={{height:"55vh"}}>
                      <GridItem xs={12}>
        <img className={classes.imgCard} style={{ maxHeight: "55vh", width: "a60vw", marginLeft: "auto", marginRight: "auto", display: "block" }} src={img5}/*src={"http://localhost:5000/" + product.image}*/ alt="Card-img" />
        </GridItem>
        </GridContainer>
      </Link>
    </Card>
